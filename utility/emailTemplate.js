export const Verification_Email_Template = `
  ...
  <body>
      <div class="container" id="containero">
          <div class="header" id="headero">Verify Your Email</div>
          <div class="content">
              <p>Hello {yourname},</p>
              <p>Thank you for signing up! Please confirm your email address by entering the code below:</p>
              <span class="verification-code" id="verification-code">{verificationCode}</span>
...
export const Welcome_Email_Template = `
  ...
  <body>
      <div class="container" id="container">
          <div class="header" id="header">Welcome to Our Community!</div>
          <div class="content">
